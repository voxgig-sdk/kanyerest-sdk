...
local GetRandomQuoteEntity = {}
GetRandomQuoteEntity.__index = GetRandomQuoteEntity


function GetRandomQuoteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomQuoteEntity)
  self._name = "get_random_quote"
  self._client = client
...
function GetRandomQuoteEntity:get_name()
  return self._name
end


function GetRandomQuoteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomQuoteEntity.new(self._client, opts)
end
...
function GetRandomQuoteEntity:mark_deleted()
  self._deleted = true
end


function GetRandomQuoteEntity:deleted()
  return true == self._deleted
end


function GetRandomQuoteEntity:data_set(args)
  if args ~= nil then
...
function GetRandomQuoteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomQuoteEntity:match_set(args)
  if args ~= nil then
...
function GetRandomQuoteEntity:match_get()
...
function GetRandomQuoteEntity:stream(action, args, callopts)
...
---@param reqmatch GetRandomQuoteLoadMatch
---@param ctrl? table
---@return GetRandomQuote
---@return string? err
function GetRandomQuoteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetRandomQuoteEntity:_run_op(ctx, post_done)
  local utility = self._utility
