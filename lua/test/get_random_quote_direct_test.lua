...
describe("GetRandomQuoteDirect", function()
  it("should direct-load-get_random_quote", function()
    local setup = get_random_quote_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_random_quote", setup.live and "live" or "unit")
...
function get_random_quote_direct_setup(mockres)
