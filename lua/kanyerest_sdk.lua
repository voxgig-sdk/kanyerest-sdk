...
local KanyerestSDK = {}
KanyerestSDK.__index = KanyerestSDK
...
KanyerestSDK._make_feature = _make_feature


function KanyerestSDK.new(options)
  local self = setmetatable({}, KanyerestSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KanyerestSDK:options_map()
...
function KanyerestSDK:get_utility()
  return Utility.copy(self._utility)
end


function KanyerestSDK:get_root_ctx()
  return self._rootctx
end


function KanyerestSDK:prepare(fetchargs)
...
function KanyerestSDK:direct(fetchargs)
...
-- by passing it.
function KanyerestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KanyerestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KanyerestSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KanyerestSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KanyerestSDK.new(sdkopts)
  sdk.mode = "test"
