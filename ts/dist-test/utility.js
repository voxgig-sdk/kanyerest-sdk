...
function envOverride(m) {
    if ('TRUE' === process.env.KANYEREST_TEST_LIVE ||
        'TRUE' === process.env.KANYEREST_TEST_OVERRIDE) {
    ...
    m.KANYEREST_TEST_EXPLAIN = process.env.KANYEREST_TEST_EXPLAIN || m.KANYEREST_TEST_EXPLAIN;
    return m;
}
