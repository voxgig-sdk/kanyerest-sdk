...
(0, node_test_1.describe)('GetRandomQuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KanyerestSDK({
    ...
    (0, node_test_1.test)('direct-load-get_random_quote', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_random_quote', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.KANYEREST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KanyerestSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KANYEREST_TEST_GET_RANDOM_QUOTE_ENTID'];
    ...
    const client = new __1.KanyerestSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomQuoteDirect.test.js.map