...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kanyerest` | `npm install @voxgig-sdk/kanyerest` |
| Python | `voxgig-sdk-kanyerest` | `pip install voxgig-sdk-kanyerest` |
| PHP | `voxgig-sdk/kanyerest` | `composer require voxgig-sdk/kanyerest` |
| Golang | `github.com/voxgig-sdk/kanyerest-sdk/go` | `go get github.com/voxgig-sdk/kanyerest-sdk/go` |
| Ruby | `voxgig-sdk-kanyerest` | `gem install voxgig-sdk-kanyerest` |
| Lua | `voxgig-sdk-kanyerest` | `luarocks install voxgig-sdk-kanyerest` |
