...
module KanyerestTestRunner
  ...
  def self.env_override(m)
    live = getenv("KANYEREST_TEST_LIVE")
    override = getenv("KANYEREST_TEST_OVERRIDE")
    ...
    explain = getenv("KANYEREST_TEST_EXPLAIN")
    m["KANYEREST_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = KanyerestTestRunner
Helpers = KanyerestHelpers
Vs = VoxgigStruct
