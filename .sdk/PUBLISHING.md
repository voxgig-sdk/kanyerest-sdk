...
|---|---|---|
| `ts/` | @voxgig-sdk/kanyerest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kanyerest-sdk \
      --repository voxgig-sdk/kanyerest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kanyerest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kanyerest-sdk --id=<id>` removes it.
