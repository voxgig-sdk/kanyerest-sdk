...
class KanyerestCacheFeature extends KanyerestBaseFeature
{
    ...
    private function _through(KanyerestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
