...
class KanyerestRbacFeature extends KanyerestBaseFeature
{
    ...
    private function _required(KanyerestContext $ctx): ?string
    {
    ...
    private function _reject(KanyerestContext $ctx, string $required): void
    {
    ...
    private function _track(KanyerestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
