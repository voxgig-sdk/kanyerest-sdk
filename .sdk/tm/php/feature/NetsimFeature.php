...
class KanyerestNetsimFeature extends KanyerestBaseFeature
{
    ...
    private function _simulate(KanyerestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KanyerestContext $ctx, array $applied): void
    {
        $client = $this->client;
