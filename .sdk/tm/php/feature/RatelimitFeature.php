...
// Kanyerest SDK ratelimit feature
...
class KanyerestRatelimitFeature extends KanyerestBaseFeature
{
    ...
    private function _acquire(KanyerestContext $ctx): void
    {
    ...
    private function _track(KanyerestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
