...
// Kanyerest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KanyerestTestFeature extends KanyerestBaseFeature
{
    ...
    public function init(KanyerestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KanyerestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KanyerestParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KanyerestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KanyerestContext $ctx, $op, $args): array
    {
