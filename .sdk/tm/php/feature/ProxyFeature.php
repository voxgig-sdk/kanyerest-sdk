...
class KanyerestProxyFeature extends KanyerestBaseFeature
{
    ...
    public function init(KanyerestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KanyerestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
