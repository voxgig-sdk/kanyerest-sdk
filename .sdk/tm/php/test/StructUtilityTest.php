...
// Kanyerest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KanyerestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KanyerestOmni::structfix($now, Struct::undef()))
                        !== json_encode(KanyerestOmni::structfix($val, Struct::undef()))) {
