...
// Kanyerest SDK utility: fetcher

class KanyerestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KanyerestSDK/1.0)';
    ...
    public static function call(KanyerestContext $ctx, string $fullurl, array $fetchdef): array
    {
