...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = KanyerestOmni.make_runner(TEST_JSON_FILE, KanyerestSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : KanyerestOmni.errify(err)
    end
