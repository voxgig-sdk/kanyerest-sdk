...
AQL-driven CLI and REPL for the Kanyerest SDK. Positional arguments are
...
./kanyerest-cli list get_random_quote
./kanyerest-cli load 1 get_random_quote
./kanyerest-cli load '{id:1}' get_random_quote
