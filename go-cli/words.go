...
func registerSDKWords(r *eng.Registry, client *sdk.KanyerestSDK) {
...
func runOp(client *sdk.KanyerestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
