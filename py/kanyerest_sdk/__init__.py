...
from kanyerest_sdk.utility import register

# Load features
from kanyerest_sdk.feature.base_feature import KanyerestBaseFeature
from kanyerest_sdk.features import _has_feature, _make_feature
...
class KanyerestSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KanyerestUtility()
        self._utility = utility

        from kanyerest_sdk.config import shared_config
    ...
    def get_utility(self):
        return KanyerestUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KanyerestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomQuote(self, data=None) -> "GetRandomQuoteEntity":
        ...
        from kanyerest_sdk.entity.get_random_quote_entity import GetRandomQuoteEntity
