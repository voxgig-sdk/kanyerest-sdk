...
from kanyerest_sdk.core.helpers import get_ctx_prop, to_map
...
class KanyerestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, KanyerestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KanyerestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KanyerestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KanyerestError(code, msg, self)
