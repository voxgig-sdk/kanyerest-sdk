...
from kanyerest_sdk.kanyerest_types import (
    GetRandomQuote,
...
class GetRandomQuoteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomQuoteEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomQuote:
    ...
    def match_get(self) -> GetRandomQuote:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomQuote:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomQuote().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
