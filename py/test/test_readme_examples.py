# Kanyerest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KanyerestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KanyerestSDK(...) and KanyerestSDK.test(...) become
#      KanyerestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kanyerest_sdk"
_SDK_CLASS = "KanyerestSDK"
