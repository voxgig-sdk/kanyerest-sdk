...
// Kanyerest SDK clienttrack feature
...
class KanyerestClienttrackFeature extends KanyerestBaseFeature
{
    ...
    public function PostConstruct(KanyerestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Kanyerest-SDK';
