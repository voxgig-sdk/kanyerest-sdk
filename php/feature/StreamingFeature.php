...
// Kanyerest SDK streaming feature
...
class KanyerestStreamingFeature extends KanyerestBaseFeature
{
    ...
    private function _iterate(KanyerestResult $result): \Generator
    {
    ...
    private function _streamable(KanyerestContext $ctx): bool
    {
