...
class KanyerestTimeoutFeature extends KanyerestBaseFeature
{
    ...
    private function _with_timeout(KanyerestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KanyerestContext $_ctx, float $ms): void
    {
        $client = $this->client;
