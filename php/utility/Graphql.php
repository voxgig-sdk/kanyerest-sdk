...
class KanyerestGraphql
{
    ...
    // equivalent.
    public static function body(KanyerestContext $ctx): mixed
    {
    ...
    public static function errors(KanyerestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
