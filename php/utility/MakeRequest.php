...
// Kanyerest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KanyerestMakeRequest
{
    public static function call(KanyerestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KanyerestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KanyerestResponse($fetched);
        } else {
