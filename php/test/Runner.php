...
class KanyerestTestRunner
{
    ...
    {
        $live = self::getenv('KANYEREST_TEST_LIVE');
        $override = self::getenv('KANYEREST_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KANYEREST_TEST_EXPLAIN');
...
class_alias('KanyerestTestRunner', 'Runner');
class_alias('KanyerestHelpers', 'Helpers');
