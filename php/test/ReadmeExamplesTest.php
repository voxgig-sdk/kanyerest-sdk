...
// Kanyerest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KanyerestSDK::test)
...
{
    private const SDK_CLASS = 'KanyerestSDK';
    ...
    private const SDK_BASE = 'kanyerest_sdk';
