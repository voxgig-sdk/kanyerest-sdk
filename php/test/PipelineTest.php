...
{
    private static function utility(): KanyerestUtility
    {
        return new KanyerestUtility();
    }
    ...
    private static function ctx(array $over = []): KanyerestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KanyerestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KanyerestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KanyerestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KanyerestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KanyerestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KanyerestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KanyerestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KanyerestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KanyerestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KanyerestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KanyerestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KanyerestResponse([]),
            'result' => new KanyerestResult([]),
        ]);
        [, $err] = KanyerestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KanyerestSpec([]),
            'response' => null,
            'result' => new KanyerestResult([]),
        ]);
        [, $err] = KanyerestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KanyerestSpec(['step' => 's']),
            'response' => new KanyerestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KanyerestResult([]),
        ]);
        [, $err] = KanyerestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KanyerestSpec(['step' => 's']),
            'response' => new KanyerestResponse(self::resp(200, ['v' => 1])),
            'result' => new KanyerestResult([]),
        ]);
        [, $err] = KanyerestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KanyerestSpec(['step' => 's']),
            'response' => new KanyerestResponse(self::resp(200, ['v' => 2])),
            'result' => new KanyerestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KanyerestMakeResponse::call($ctx);
    ...
    {
        $preset = new KanyerestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KanyerestSpec([]),
            'response' => new KanyerestResponse([]),
            'result' => new KanyerestResult([]),
        ...
        [$got, $err] = KanyerestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KanyerestResult([])]);
        [, $err] = KanyerestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KanyerestSpec([]), 'result' => null]);
        [, $err] = KanyerestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KanyerestSpec(['step' => 's']),
            'result' => new KanyerestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KanyerestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KanyerestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KanyerestSpec(['step' => 's']),
            'result' => new KanyerestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KanyerestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KanyerestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KanyerestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KanyerestSpec([]),
            'result' => new KanyerestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KanyerestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KanyerestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KanyerestError('boom', 'boom');
        $utility->fetcher = function (KanyerestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KanyerestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KanyerestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KanyerestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KanyerestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KanyerestResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KanyerestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KanyerestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KanyerestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KanyerestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KanyerestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KanyerestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KanyerestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KanyerestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KanyerestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KanyerestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KanyerestResult(['ok' => false])]);
        $this->expectException(KanyerestError::class);
        KanyerestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KanyerestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KanyerestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KanyerestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KanyerestBaseFeature();
        $b = new KanyerestBaseFeature();
        KanyerestFeatureAdd::call($ctx, $a);
        KanyerestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KanyerestBaseFeature
    {
        $f = new KanyerestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KanyerestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KanyerestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KanyerestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KanyerestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KanyerestResponse(['headers' => null]),
            'result' => new KanyerestResult([]),
        ]);
        KanyerestResultHeaders::call($ctx);
