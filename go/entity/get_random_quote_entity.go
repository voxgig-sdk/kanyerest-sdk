...
import (
	...
	vs "github.com/voxgig-sdk/kanyerest-sdk/go/utility/struct"
)

type GetRandomQuoteEntity struct {
	name    string
	client  *core.KanyerestSDK
...
func NewGetRandomQuoteEntity(client *core.KanyerestSDK, entopts map[string]any) *GetRandomQuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRandomQuoteEntity) GetName() string { return e.name }
...
func (e *GetRandomQuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRandomQuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRandomQuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRandomQuoteEntity(e.client, opts)
}

func (e *GetRandomQuoteEntity) Data(args ...any) any {
...
func (e *GetRandomQuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRandomQuote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRandomQuoteEntity) DataTyped(data ...GetRandomQuote) GetRandomQuote {
	if len(data) > 0 {
		return typedFrom[GetRandomQuote](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRandomQuote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRandomQuote (all fields
// optional at the wire level).
func (e *GetRandomQuoteEntity) MatchTyped(match ...GetRandomQuote) GetRandomQuote {
	if len(match) > 0 {
		return typedFrom[GetRandomQuote](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRandomQuote](e.Match())
}
...
func (e *GetRandomQuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRandomQuoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRandomQuoteLoadMatch and returns an GetRandomQuote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRandomQuoteEntity) LoadTyped(reqmatch GetRandomQuoteLoadMatch, ctrl map[string]any) (GetRandomQuote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRandomQuote{}, err
	}
	return typedFrom[GetRandomQuote](res), nil
}



func (e *GetRandomQuoteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRandomQuoteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRandomQuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRandomQuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRandomQuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
