...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_random_quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KanyerestSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kanyerest_list",
		Description: "List records from Kanyerest. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kanyerest_load",
		Description: "Load a single record from Kanyerest. " +
...
func runOp(client *sdk.KanyerestSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KanyerestSDK, name string) (sdk.KanyerestEntity, error) {
	switch strings.ToLower(name) {
	case "get_random_quote":
		return client.GetRandomQuote(nil), nil
